...
interview2 = Interview.create!(date: Date.parse("01.12.2020"), start_time: Time.new(2020,12,12,17), end_time: Time.new(2020,12,12,19), focus: "Ruby", experience: "Beginner", interview_language: "German", user: mary)
...
interview9 = Interview.create!(date: Date.parse("04.12.2020"), start_time: Time.new(2020,12,12,18), end_time: Time.new(2020,12,12,19), focus: "Ruby", experience: "Senior Level", interview_language: "German", user: zoe)
