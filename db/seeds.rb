...
interview4 = Interview.create!(date: Date.parse("13.12.2020"), start_time: Time.new(2020,12,13,17), end_time: Time.new(2020,12,13,19), focus: "Ruby", experience: "Medium Level", interview_language: "Spanish", user: peter)
