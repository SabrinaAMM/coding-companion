...
interview4 = Interview.create!(date: Date.parse("03.12.2020"), start_time: Time.new(2020,11,27,21), end_time: Time.new(2020,11,27,23), focus: "Javascript", experience: "Expert", interview_language: "English", user: zoe)
...
interview8 = Interview.create!(date: Date.parse("03.12.2020"), start_time: Time.new(2020,12,13,22), end_time: Time.new(2020,12,13,23), focus: "Ruby", experience: "Beginner", interview_language: "English", user: nico)
# Tomorrow
